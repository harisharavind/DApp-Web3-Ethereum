...
contract('ChainList', function(accounts){
  ...
  it("should let us sell a first article", function() {
    return ChainList.deployed().then(function(instance){
      ...
      return chainListInstance.sellArticle(
        articleName1,
        articleDescription1,
        web3.utils.toWei(web3.utils.toBN(articlePrice1), "ether"),
        {from: seller}
      );
      ...
      //console.log(receipt.logs[0].args._price);
      //console.log(web3.utils.toWei(web3.utils.toBN(articlePrice1), "ether"));
      //assert.equal(receipt.logs[0].args._price, web3.utils.toWei(web3.utils.toBN(articlePrice1), "ether"), "event article price must be " + web3.utils.toWei(web3.utils.toBN(articlePrice1), "ether"));
      ...
      //assert.equal(data[5], web3.utils.toWei(web3.utils.toBN(articlePrice1), "ether"), "article price must be " + web3.utils.toWei(web3.utils.toBN(articlePrice1), "ether"));
    });
  });
  ...
  it("should let us sell a second article", function() {
    return ChainList.deployed().then(function(instance){
      ...
      return chainListInstance.sellArticle(
        articleName2,
        articleDescription2,
        web3.utils.toWei(web3.utils.toBN(articlePrice2), "ether"),
        {from: seller}
      );
    }).then(function(receipt){
      // check event
      ...
      //assert.equal(receipt.logs[0].args._price, web3.utils.toWei(web3.utils.toBN(articlePrice2), "ether"), "event article price must be " + web3.utils.toWei(web3.utils.toBN(articlePrice2), "ether"));
      ...
      //assert.equal(data[5], web3.utils.toWei(web3.utils.toBN(articlePrice2), "ether"), "article price must be " + web3.utils.toWei(web3.utils.toBN(articlePrice2), "ether"));
    });
  });
  ...
  it("should buy an article", function(){
    return ChainList.deployed().then(function(instance) {
      ...
      var buyerbalance;
      beforeEach(async() => {
        sellerbalance = await web3.eth.getBalance(seller).toString();
      });
      beforeEach(async() => {
        buyerbalance = await web3.eth.getBalance(buyer).toString();
      });

      sellerBalanceBeforeBuy = web3.utils.fromWei(sellerbalance + typeof string, "ether");
      buyerBalanceBeforeBuy = web3.utils.fromWei(buyerbalance, "ether");
      return chainListInstance.buyArticle(1, {
        from: buyer,
        value: web3.utils.toWei(web3.utils.toBN(articlePrice1), "ether")
      });
    }).then(function(receipt){
      assert.equal(receipt.logs.length, 1, "one event should have been triggered");
      ...
      sellerBalanceAfterBuy = web3.utils.fromWei(web3.eth.getBalance(seller.toString()), "ether");
      buyerBalanceAfterBuy = web3.utils.fromWei(web3.eth.getBalance(buyer.toString()), "ether");
